    ...
    <main>
      <section className="relative overflow-hidden">
        ...
        <div className="container py-[var(--hero-pad)] relative">
          ...
          <>
            <Sticker src="https://cdn-bewildcard.wildcard.com.cn/static/media/github.eb6b2cd9b152e26df29e.png" x="8%" y="8%" rotate={-12} opacity={0.95} className="scale-75 md:scale-100 animate-float-slow" />
            <Sticker src="https://cdn-bewildcard.wildcard.com.cn/static/media/google.c0a1ffab09641599ec51.png" x="18%" y="22%" rotate={8} opacity={0.9} className="hidden md:block animate-float-slow" />
