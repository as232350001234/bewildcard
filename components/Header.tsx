...
export default function Header() {
  return (
    <header className="sticky top-0 z-50 bg-[var(--bg)]/70 backdrop-blur-sm border-b border-black/5">
      <div className="container h-14 md:h-16 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-3">
          <Link href="#" className="inline-flex h-9 items-center rounded-full bg-white/80 px-3 text-xs font-medium text-neutral-800 shadow-sm ring-1 ring-black/5 hover:bg-white">
            登录/注册
          </Link>
